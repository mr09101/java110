...
--게시문 첨부파일
insert into p1_att_file(fl_nm,bno) values('file1.txt',1);
insert into p1_att_file(fl_nm,bno) values('file2.txt',1);
insert into p1_att_file(fl_nm,bno) values('file3.txt',2);
insert into p1_att_file(fl_nm,bno) values('file4.txt',3);
insert into p1_att_file(fl_nm,bno) values('file5.txt',3);
insert into p1_att_file(fl_nm,bno) values('file6.txt',5);
insert into p1_att_file(fl_nm,bno) values('file7.txt',9);
